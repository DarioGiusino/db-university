...
SELECT `students`.`surname` AS 'student_surname', `students`.`name` AS 'student_name', COUNT(`exam_student`.`vote`) AS 'attemps', `courses`.`name` AS 'course_name', MAX(`exam_student`.`vote`) AS 'max_vote'
FROM `students`
JOIN `exam_student`
